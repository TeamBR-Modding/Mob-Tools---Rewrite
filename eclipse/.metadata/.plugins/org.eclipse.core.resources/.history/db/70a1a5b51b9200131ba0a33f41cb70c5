...
public class MobToolsTeleportAmulet extends MobToolsAmulet {
	...
	public MobToolsTeleportAmulet(int par1) {
		super(par1);
	...
	public ItemStack onItemRightClick(ItemStack itemstack, World par2World, EntityPlayer player)
	{
		...
		if(player.isSneaking())
		{
			if(itemstack.stackTagCompound == null)
			{
				...
				if(!par2World.isRemote)
					player.addChatMessage(EnumChatFormatting.DARK_PURPLE + "Location Set");
		...
		else if(itemstack.stackTagCompound != null)
		{
			...
			{
				if(!par2World.isRemote)
					player.addChatMessage(EnumChatFormatting.DARK_PURPLE + "Cannot Teleport to different Dimension");
			}
